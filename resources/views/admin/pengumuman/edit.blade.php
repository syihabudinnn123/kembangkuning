        ...
        <div class="card-body">
            <form action="{{ route('admin.pengumuman.update', $pengumuman)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    placeholder="Masukkan Judul Pengumuman"  value="{{ $pengumuman->nama ?? old('nama') }}">
                    @error('nama')
                ...
                <div class="form-group">
                    ...
                    placeholder="Tuliskan Deskripsi Tentang Pengumuman"> {{$pengumuman->deskripsi?? old ('deskripsi') }} </textarea>
                    @error('deskripsi')
                        <span  class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    placeholder="Masukkan Jumlah Buku" value="{{ $pengumuman->tanggal ?? old('tanggal') }}">
                    @error('tanggal')
                        <span  class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
