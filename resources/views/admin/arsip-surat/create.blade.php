        ...
        <div class="card-body">
            <form action="{{ route('admin.arsip-surat.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="form-row ml-1">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="jenis_surat" id="inlineRadio1" value="Surat Masuk">
                ...
                <div class="form-group">
                        ...
                        <select name="kategori_id" id="" class="form-control select2">
                            @foreach ($kategori as $k)
                                <option value="{{ $k->id }}" class="">{{ $k->nama_kategori }}</option>
                            @endforeach
                        </select>
                        @error('warga_id')
                ...
                <div class="form-group">
                    ...
                    placeholder="Masukkan Unit Asal / Tujuan Surat" >
                    @error('nama_kategori')
                        <span  class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
