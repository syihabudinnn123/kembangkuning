...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Tambah Data Profil Desa</h3>
    </div>
    <div class="card-body">
        <form  action="{{ route('admin.profil.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                placeholder="Masukkan Nama Desa" value="{{ old('nama') }}">
                @error('nama')
            ...
            <div class="form-group">
                ...
                placeholder="Masukkan Sejarah Desa">{{old ('sejarah') }}</textarea>
                @error('sejarah')
                    <span  class="text-danger"> {{ $message }} </span>
                @enderror
            </div>
            <div class="form-group">
                ...
                placeholder="Masukkan Deskripsi Tentang SIDESA">{{old ('tentang') }}</textarea>
                @error('tentang')
                    <span  class="text-danger"> {{ $message }} </span>
                @enderror
            </div>
            <div class="form-group">
                ...
                placeholder="Masukkan Fungsi SIDESA">{{old ('fungsi') }}</textarea>
                @error('fungsi')
                    <span  class="text-danger"> {{ $message }} </span>
                @enderror
            </div>
